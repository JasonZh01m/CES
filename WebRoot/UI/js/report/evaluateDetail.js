...
$("#sb_q").searchBar({
	items:[
	       ...
	       {field:"开始日期",id:"startTime",name:"startTime",type:"text"},
	   	   ...
	   	   {field:"员工信息",name:"empField",type:"text"}
	],
	button:[
...
$("#mainGrid").jqGrid({
	...
	height:h-53-sbh,
	mtype: 'POST',
	url:cp+'/report/evaluateDetail.do', 
	datatype: "json", 
	altclass:'odd',
	jsonReader:{
	    root:'rows',
	...
	colNames:['机构名','员工姓名','操作窗口','受理业务','评价等级','受理时长','评价时间'], 
	colModel:[
	{name:'orgName',index:'orgName', width:80,search: false,hidden:false,sortable:false},
	{name:'employeeName',index:'employeeName', width:80,hidden:false,sortable:false},
	{name:'windowName',index:'windowName', width:80,hidden:false,sortable:false}, 
	{name:'serviceName',index:'serviceName', width:80,hidden:false,sortable:false}, 
	{name:'evaluateName',index:'evaluateName', width:80,hidden:false,sortable:false}, 
	{name:'duration',index:'duration', width:80,hidden:false,sortable:false}, 
	{name:'rectime',index:'rectime', width:80,hidden:false,sortable:false}
	],
	multiselect: true,
	rowNum:25, 
	rowList:[25,35,50], 
